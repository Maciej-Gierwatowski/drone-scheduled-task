...
/// New section - run task
    //fmt.Println("Task params:")
    taskParams := &ecs.RunTaskInput{
        Cluster:                    aws.String(p.Cluster),
        Count:                      aws.Int64(1), // TODO: specify
        ...
        PlatformVersion:            aws.String("LATEST"), // TODO: specify
        PropagateTags:              aws.String("TASK_DEFINITION"), // TODO: specify // values: TASK_DEFINITION or not specified
        //Tags:                     TODO
        TaskDefinition:             aws.String(val), // TODO: give an option to not create a new task definition on each run, use existing one instead
    }
    //fmt.Println(taskParams)
    ...
    // Check all containers exit code
	...
	_, serr := svc.UpdateService(sparams)  // temporary
	if serr != nil {
		return serr
	}
